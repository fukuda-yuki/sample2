...
この本文は採取時評価の履歴です。後続の本体修正、独立再監査、R-029の訂正は
[修正・訂正評価報告](ms1-correction-20260919-report.md)を参照してください。
新規preload-001の訂正評価は96.55点・R-010のみ不合格です。元の93.1点の記録は保持しています。
...
採取時の `outer/harness/runtime.py` はRunコンテナーを止めるが、専用ネットワークを回収しないため蓄積していた。
