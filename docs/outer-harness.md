...
**ビルドしたコミットも値に混ぜない**（同 §6.4。`45a2b4a` のビルドは `76ae7269…`、`6675e19` の
ビルドは `60c8fbd4…` と食い違い、アセンブリにコミットが埋まっていた。
[`inner/calibration/README.md`](../inner/calibration/README.md) §4.2）。
